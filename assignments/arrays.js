...
// ==== Challenge 2 ====
// The dealer needs the informa(tion on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = inventory.filter((car) => {
    if (car.id === 50) {
        return true;
    }
    return false;
})
console.log(`The last car in the inventory is a ${inventory[49].car_make} ${inventory[49].car_model}`);
